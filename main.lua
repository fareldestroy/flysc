...
-- Stable WindUI-compatible gallery.
-- Custom swipe carousel was removed because WindUI tab items do not support direct custom GUI injection reliably.
HomeTab:Image({
    Title = "Fly Script",
    Description = "Creator Farel",
    Image = "https://files.catbox.moe/446kdc.jpg"
})

HomeTab:Image({
    Title = "New Update",
    Description = "Version 1.0 Beta",
    Image = "https://files.catbox.moe/x606go.jpg"
})

HomeTab:Image({
    Title = "Next Update",
    Description = "Adding Anti-ban From Server",
    Image = "https://files.catbox.moe/0zy3wr.jpg"
})
