...
Text.Text = "Loading Fly Script..."
Text.TextColor3 = Color3.fromRGB(255,255,255)
Text.TextScaled = true
Text.Size = UDim2.new(0.4,0,0.1,0)
Text.Position = UDim2.new(0.3,0,0.45,0)
Text.Parent = Frame
...
sliderFrame.Size = UDim2.new(1,0,0,200)
sliderFrame.CanvasSize = UDim2.new(3,0,0,0)
sliderFrame.ScrollBarThickness = 0
sliderFrame.ScrollingDirection = Enum.ScrollingDirection.X
sliderFrame.Parent = Window.MainContainer

local layout = Instance.new("UIListLayout")
layout.FillDirection = Enum.FillDirection.Horizontal
layout.Parent = sliderFrame

local function createSlide(img,title,desc)
    ...
    t.Position = UDim2.new(0,0,0.8,0)
    ...
    d.Position = UDim2.new(0,0,0.9,0)
...
createSlide("https://files.catbox.moe/446kdc.jpg","Fly Script","Creator Farel")
createSlide("https://files.catbox.moe/x606go.jpg","New Update","Version 1.0 Beta")
createSlide("https://files.catbox.moe/0zy3wr.jpg","Next Update","Adding Anti-ban From Server")
...
HomeTab:Button({
    Title = "WhatsApp",
    Callback = function()
        setclipboard("https://wa.me/6282172505548")
        WindUI:Notify({
            Title = "WhatsApp",
            Content = "Link copied to clipboard",
            Duration = 3
