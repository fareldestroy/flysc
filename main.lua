...
local carouselGui = Instance.new("Frame")
carouselGui.Size = UDim2.new(1,0,0,200)
carouselGui.BackgroundTransparency = 1
carouselGui.Parent = game.CoreGui

local scroll = Instance.new("ScrollingFrame")
scroll.Size = UDim2.new(1,0,1,0)
scroll.ScrollBarThickness = 0
scroll.ScrollingDirection = Enum.ScrollingDirection.X
scroll.CanvasSize = UDim2.new(3,0,0,0)
scroll.Parent = carouselGui
