...
HomeTab:Section({ Title = "Highlight Showcase" })

HomeTab:ImageCarousel({
    Title = "Farel Destroyer News",
    Description = "Update terbaru & info script ada di slide ini!",
    Images = {
        {
            Image = "rbxassetid://10899451121", -- Ganti ID gambar 1
            Title = "Welcome to Farel Fly",
            Content = "Script fly paling smooth buat mobile dan PC."
        },
        {
            Image = "rbxassetid://10899453712", -- Ganti ID gambar 2
            Title = "Anti-Kick System",
            Content = "Sudah dilengkapi bypass kick biar aman pas exploit."
        },
        {
            Image = "rbxassetid://10899455385", -- Ganti ID gambar 3
            Title = "Update V1.0 Beta",
            Content = "Follow telegram kita buat dapetin update terbaru!"
        }
    }
})
