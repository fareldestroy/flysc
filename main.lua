...
-- =============================================
-- IMAGE CAROUSEL (No UIPageLayout - stable)
-- =============================================
local images = {
...
carouselWrapper.Size = UDim2.new(1, -16, 0, 160)
carouselWrapper.Position = UDim2.new(0, 8, 0, 0)
carouselWrapper.BackgroundTransparency = 1
carouselWrapper.ClipsDescendants = false
carouselWrapper.Parent = HomeTab.Container

-- Clip frame (hides overflow)
local clipFrame = Instance.new("Frame")
clipFrame.Name = "ClipFrame"
clipFrame.Size = UDim2.new(1, 0, 0, 140)
clipFrame.Position = UDim2.new(0, 0, 0, 0)
clipFrame.BackgroundTransparency = 1
clipFrame.ClipsDescendants = true
clipFrame.Parent = carouselWrapper

-- Slide strip (holds all images side by side)
local stripWidth = #images
local strip = Instance.new("Frame")
strip.Name = "Strip"
strip.Size = UDim2.new(stripWidth, 0, 1, 0)
...
for i, id in ipairs(images) do
    ...
    slide.Name = "Slide_" .. i
    slide.Size = UDim2.new(1 / stripWidth, -8, 1, -4)
    slide.Position = UDim2.new((i - 1) / stripWidth, 4, 0, 2)
    slide.BackgroundColor3 = Color3.fromRGB(30, 30, 35)
...
dotFrame.Name = "Dots"
dotFrame.Size = UDim2.new(1, 0, 0, 14)
dotFrame.Position = UDim2.new(0, 0, 0, 143)
...
for i = 1, #images do
    ...
    dot.Name = "Dot_" .. i
    dot.Size = UDim2.new(0, i == 1 and 18 or 6, 0, 6)
    dot.BackgroundColor3 = i == 1 and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(100, 100, 110)
...
local function goToSlide(targetIndex)
    ...
    -- Animate strip
    local targetX = -((targetIndex - 1) / stripWidth)
    ...
    for i, dot in ipairs(dots) do
        ...
        TweenService:Create(dot,
            ...
            {
                Size = UDim2.new(0, isActive and 18 or 6, 0, 6),
                BackgroundColor3 = isActive and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(100, 100, 110)
            }
        ):Play()
    end
end
...
task.spawn(function()
    while true do
        task.wait(3)
        local next = carouselIndex % #images + 1
        goToSlide(next)
    end
end)
-- =============================================
