...
sg.Name = "farel_image_carousel"
sg.ResetOnSpawn = false
sg.Parent = player.PlayerGui

-- Frame utama
local carouselFrame = Instance.new("Frame")
carouselFrame.Size = UDim2.new(0,350,0,200)
carouselFrame.Position = UDim2.new(0.5,-175,0.42,-110)
carouselFrame.BackgroundColor3 = Color3.fromRGB(20,20,20)
...
mainCorner.Parent = carouselFrame
...
pageLayout.Parent = carouselFrame
...
imgContainer.Name = "Slide_"..i
imgContainer.Size = UDim2.new(1,0,1,0)
imgContainer.BackgroundTransparency = 1
imgContainer.Parent = carouselFrame

local imgLabel = Instance.new("ImageLabel")
imgLabel.Size = UDim2.new(1,0,1,0)
imgLabel.Image = id
imgLabel.ScaleType = Enum.ScaleType.Crop
imgLabel.BackgroundColor3 = Color3.fromRGB(30,30,30)
...
indicatorContainer.Size = UDim2.new(0,100,0,20)
indicatorContainer.Position = UDim2.new(0.5,-50,0.5,45)
indicatorContainer.BackgroundTransparency = 1
indicatorContainer.Parent = sg

local listLayout = Instance.new("UIListLayout")
listLayout.FillDirection = Enum.FillDirection.Horizontal
listLayout.HorizontalAlignment = Enum.HorizontalAlignment.Center
listLayout.Padding = UDim.new(0,5)
listLayout.Parent = indicatorContainer

for i = 1,#images do

local dot = Instance.new("Frame")
dot.Size = UDim2.new(0,8,0,8)
dot.BackgroundColor3 = (i == 1) and Color3.new(1,1,1) or Color3.new(0.5,0.5,0.5)
dot.Parent = indicatorContainer
