...
local images = {
    {
        img = "https://files.catbox.moe/446kdc.jpg",
        title = "Fly Script",
        desc = "Creator Farel"
    },
    {
        img = "https://files.catbox.moe/x606go.jpg",
        title = "New Update",
        desc = "Version 1.0 Beta"
    },
    {
        img = "https://files.catbox.moe/0zy3wr.jpg",
        title = "Next Update",
        desc = "Adding Anti-ban From Server"
    }
}

local current = 1

local slider = HomeTab:Image({
    Title = images[current].title,
    Description = images[current].desc,
...
HomeTab:Button({
    Title = "Telegram",
    Callback = function()
        game:GetService("GuiService"):OpenBrowserWindow("https://t.me/nyxdestroy")
    end
})
...
HomeTab:Button({
    Title = "WhatsApp",
    Callback = function()
        game:GetService("GuiService"):OpenBrowserWindow("https://wa.me/6282172505548")
    end
})
